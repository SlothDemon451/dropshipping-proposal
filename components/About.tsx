...
import { FaStore, FaPalette, FaSearch, FaBullhorn, FaWarehouse } from 'react-icons/fa'
...
const features = [
  ...
  { icon: FaWarehouse , title: 'Supplier Hunting', description: 'Finding nearest supplier with the best & fastest shipping rate available.' },
  { icon: IoBagHandle , title: 'Store Handling', description: 'Handling store 24/7 & engaging with customers to find the right product for them.' },
]
    ...
    <section id="about" className="py-20 bg-gray-50">
      <div className="container mx-auto px-6">
        ...
        <p className="text-center text-gray-600 mb-12 max-w-3xl mx-auto">
          We specialize in building and managing dropshipping stores tailored for WorldWide markets. With years of experience, we ensure your business thrives with reliable suppliers, profitable product strategies, and cutting-edge marketing campaigns.
        </p>
